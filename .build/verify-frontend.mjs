...
const expected = [
  "list_files", "search_files", "grep_files", "read_file", "read_document", "diff_file", "restore_file",
  // the opt-in document index
  "index_status", "index_search", "index_rebuild", "index_clear", "write_file", "create_folder",
